...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    red_total_wins = HEALTH_FONT.render("Wins: " + str(wins['Red']), True, WHITE)
    yellow_total_wins = HEALTH_FONT.render("Wins: " + str(wins['Yellow']), True, WHITE)
    WIN.blit(red_health_text, (WIDTH-red_health_text.get_width()-10, 10))
    WIN.blit(yellow_health_text, (10, 10))
    WIN.blit(red_total_wins, (WIDTH-red_health_text.get_width()-10, 50))
    WIN.blit(yellow_total_wins, (10, 50))
